...
class ComputersControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post :create, computer: { description: @computer.description, ipaddr: @computer.ipaddr, macaddr: @computer.macaddr, name: @computer.name, status: @computer.status }
    end
  ...
  test "should update computer" do
    patch :update, id: @computer, computer: { description: @computer.description, ipaddr: @computer.ipaddr, macaddr: @computer.macaddr, name: @computer.name, status: @computer.status }
    assert_redirected_to computer_path(assigns(:computer))
  end
